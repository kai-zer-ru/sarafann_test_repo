...
{
    public const SIMPLE_FORMAT = "[%datetime%] %channel%.%level_name% %extra%\n";
    ...
    /**
     * @param null|string $format                The format of the message
    ...
    {
        $this->format = null === $format ? static::SIMPLE_FORMAT : $format;
